...
!(function () {
	...
	function t(t, e, i, s) {
		...
		else for (var a = t.length - 1; a >= 0; a--) (n = t[a]) && (o = (r < 3 ? n(o) : r > 3 ? n(e, i, o) : n(e, i)) || o);
	...
	let o = class {
		...
		get styleSheet() {
			...
			if (s && void 0 === t) {
				...
				(i && (t = r.get(e)),
					void 0 === t && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), i && r.set(e, t)));
			}
			return t;
		}
		toString() {
	...
	const c = window,
		...
		g = (t, e) => e !== t && (e == e || t == t),
		b = { attribute: !0, type: String, converter: v, reflect: !1, hasChanged: g };
	let y = class extends HTMLElement {
					...
					s
						...
						: e.forEach((e) => {
								const s = document.createElement("style"),
									n = i.litNonce;
								(void 0 !== n && s.setAttribute("nonce", n), (s.textContent = e.cssText), t.appendChild(s));
							});
		...
		_$EO(t, e, i = b) {
			...
			if (void 0 !== n && !0 === i.reflect) {
				const r = (
					void 0 !== (null === (s = i.converter) || void 0 === s ? void 0 : s.toAttribute) ? i.converter : v
		...
		requestUpdate(t, e, i) {
			let s = !0;
			(void 0 !== t &&
				(((i = i || this.constructor.getPropertyOptions(t)).hasChanged || g)(this[t], e)
		...
		update(t) {
			(void 0 !== this._$EC && (this._$EC.forEach((t, e) => this._$EO(e, this[e], t)), (this._$EC = void 0)),
				this._$Ek());
		}
		updated(t) {}
		firstUpdated(t) {}
	...
	((y.finalized = !0),
		...
		(null !== (d = c.reactiveElementVersions) && void 0 !== d ? d : (c.reactiveElementVersions = [])).push("1.4.1"));
	const m = window,
		$ = m.trustedTypes,
		...
		H = (t, e) => {
			...
			for (let e = 0; e < i; e++) {
				...
				let a,
					...
					d = -1,
					c = 0;
				for (; c < i.length && ((o.lastIndex = c), (l = o.exec(i)), null !== l); )
					((c = o.lastIndex),
						o === I
							? "!--" === l[1]
								? (o = E)
							...
							: o === N
								? ">" === l[0]
									...
									: void 0 === l[1]
										? (d = -2)
										: ((d = o.lastIndex - l[2].length), (a = l[1]), (o = void 0 === l[3] ? N : '"' === l[3] ? j : D))
								: o === j || o === D
									? (o = N)
									: o === E || o === C
										? (o = I)
	...
	class Z {
		constructor({ strings: t, _$litType$: e }, i) {
			...
			const o = t.length - 1,
				a = this.parts,
				[l, d] = H(t, e);
			if (((this.el = Z.createElement(l, i)), (P.currentNode = this.el.content), 2 === e)) {
				...
				if (1 === s.nodeType) {
					...
					if (T.test(s.tagName)) {
						...
						if (e > 0) {
							...
							for (let i = 0; i < e; i++) (s.append(t[i], S()), P.nextNode(), a.push({ type: 2, index: ++n }));
							s.append(t[e], S());
						}
					}
					...
					if (s.data === _) a.push({ type: 2, index: n });
						...
						let t = -1;
						for (; -1 !== (t = s.data.indexOf(w, t + 1)); ) (a.push({ type: 7, index: n }), (t += w.length - 1));
					}
				n++;
			}
		}
	...
	function Y(t, e, i = t, s) {
		var n, r, o, a;
		if (e === U) return e;
		let l = void 0 !== s ? (null === (n = i._$Co) || void 0 === n ? void 0 : n[s]) : i._$Cl;
		const d = M(e) ? void 0 : e._$litDirective$;
		return (
			(null == l ? void 0 : l.constructor) !== d &&
				(null === (r = null == l ? void 0 : l._$AO) || void 0 === r || r.call(l, !1),
				void 0 === d ? (l = void 0) : ((l = new d(t)), l._$AT(t, i, s)),
				void 0 !== s ? ((null !== (o = (a = i)._$Co) && void 0 !== o ? o : (a._$Co = []))[s] = l) : (i._$Cl = l)),
	...
	class B {
		...
		v(t) {
			...
			const {
				...
				n = (null !== (e = null == t ? void 0 : t.creationScope) && void 0 !== e ? e : A).importNode(i, !0);
			P.currentNode = n;
			let r = P.nextNode(),
				o = 0,
				a = 0,
	...
	class V {
		constructor(t, e, i, s) {
			...
			((this.type = 2),
				...
				(this._$AM = i),
				(this.options = s),
				(this._$Cm = null === (n = null == s ? void 0 : s.isConnected) || void 0 === n || n));
		}
		get _$AU() {
			var t, e;
			...
			((t = Y(this, t, e)),
				M(t)
					...
					: void 0 !== t._$litType$
						...
						: void 0 !== t.nodeType
							? this.T(t)
							: ((t) => k(t) || "function" == typeof (null == t ? void 0 : t[Symbol.iterator]))(t)
								? this.k(t)
								: this.g(t));
		}
		O(t, e = this._$AB) {
		...
		g(t) {
			(this._$AH !== O && M(this._$AH) ? (this._$AA.nextSibling.data = t) : this.T(A.createTextNode(t)),
				(this._$AH = t));
		}
		$(t) {
			var e;
			const { values: i, _$litType$: s } = t,
				n = "number" == typeof s ? this._$AC(t) : (void 0 === s.el && (s.el = Z.createElement(s.h, this.options)), s);
		...
		k(t) {
			...
			let i,
				s = 0;
			for (const n of t)
				(s === e.length ? e.push((i = new V(this.O(S()), this.O(S()), this, this.options))) : (i = e[s]),
					i._$AI(n),
					s++);
	...
	class G {
		...
		_$AI(t, e = this, i, s) {
			...
			let r = !1;
			if (void 0 === n) ((t = Y(this, t, e, 0)), (r = !M(t) || (t !== this._$AH && t !== U)), r && (this._$AH = t));
			else {
				const s = t;
				let o, a;
		...
		j(t) {
			t === O ? this.element.removeAttribute(this.name) : this.element.setAttribute(this.name, null != t ? t : "");
		}
	}
	class W extends G {
		constructor() {
	...
	class q extends G {
		...
		j(t) {
			t && t !== O ? this.element.setAttribute(this.name, Q) : this.element.removeAttribute(this.name);
		}
	}
	class F extends G {
		constructor(t, e, i, s, n) {
		...
		_$AI(t, e = this) {
			var i;
			if ((t = null !== (i = Y(this, t, e, 0)) && void 0 !== i ? i : O) === U) return;
			const s = this._$AH,
				n = (t === O && s !== O) || t.capture !== s.capture || t.once !== s.once || t.passive !== s.passive,
				r = t !== O && (s === O || n);
	...
	(null == K || K(Z, V),
		(null !== (f = m.litHtmlVersions) && void 0 !== f ? f : (m.litHtmlVersions = [])).push("2.4.0"));
	var X, tt;
	let et = class extends y {
		...
		createRenderRoot() {
			...
			return (
				(null !== (t = (e = this.renderOptions).renderBefore) && void 0 !== t) || (e.renderBefore = i.firstChild),
				i
			);
		}
		update(t) {
			...
			(this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
				...
				(this._$Do = ((t, e, i) => {
					...
					if (void 0 === o) {
						...
						r._$litPart$ = o = new V(e.insertBefore(S(), t), t, void 0, null != i ? i : {});
					}
					return (o._$AI(t), o);
	...
	((et.finalized = !0),
		(et._$litElement$ = !0),
		null === (X = globalThis.litElementHydrateSupport) || void 0 === X || X.call(globalThis, { LitElement: et }));
	const it = globalThis.litElementPolyfillSupport;
	(null == it || it({ LitElement: et }),
		(null !== (tt = globalThis.litElementVersions) && void 0 !== tt ? tt : (globalThis.litElementVersions = [])).push(
			"3.2.2",
		));
	const st = (t) => (e) =>
			"function" == typeof e
	...
	var ot;
	null === (ot = window.HTMLSlotElement) || void 0 === ot || ot.prototype.assignedElements;
	class at {
		constructor() {
			this.handlers = [];
		}
		...
		handleMutation(t) {
			...
			(t.forEach((t) => {
				for (const i of t.addedNodes)
					this.nodeNames.indexOf(i.nodeName.toLowerCase()) > -1 && ((e = !0), this.items.push(i));
	...
	const xt = new (class {
			...
			async connect(t, e, i, s, n) {
				if (!this._isInitialized) {
					const r = { actionInfo: n, info: s, propertyInspectorUUID: e, registerEvent: i };
					(r.actionInfo && this.didReceiveSettings.dispatch(r.actionInfo), this._connectionInfo.setResult(r));
					const o = new WebSocket(`ws://localhost:${t}`);
					((o.onmessage = this.handleMessage.bind(this)),
						(o.onopen = () => {
							(o.send(JSON.stringify({ event: r.registerEvent, uuid: r.propertyInspectorUUID })),
			...
			async getGlobalSettings() {
				return (await this.get("getGlobalSettings", "didReceiveGlobalSettings")).payload.settings;
			}
			setGlobalSettings(t) {
			...
			async getSettings() {
				...
				return (
					await this.get(
						"getSettings",
						"didReceiveSettings",
						(e) => e.action == t.action && e.context == t.context && e.device == t.device,
					)
				).payload;
			}
			setSettings(t) {
			...
			async get(t, e, i, s) {
				const n = new lt(),
					r = (t) => {
						if (t.event === e) {
							const e = t;
							(void 0 === i || i(e)) && (this.message.unsubscribe(r), n.setResult(e));
						}
					};
			...
			async send(t, e) {
				...
				(await this._connection.promise).send(
					JSON.stringify({ event: t, context: i.propertyInspectorUUID, payload: e, action: i.actionInfo.action }),
				);
			}
			handleMessage(t) {
		...
		wt = (i) => {
			class s extends i {
				constructor(...t) {
					(super(t),
						...
						(this._mutationObserver = new ht(["optgroup", "option"], () => this.refresh())),
						(this.hotReload = !1),
						(this.loadingText = new bt("Loading...")),
						(this.items = new (class {
							constructor(t, e, i) {
								((this.i = 0), (this.status = 0), (this.autoRun = !0), (this.o = t), this.o.addController(this));
							...
							async performTask() {
								var t;
								const e = null === (t = this.h) || void 0 === t ? void 0 : t.call(this);
							...
							async run(t) {
								var e, i, s;
								let n, r;
								(null != t || (t = null === (e = this.h) || void 0 === e ? void 0 : e.call(this)),
								...
								if (this.i === o) {
									if (n === $t) this.status = 0;
										...
										if (void 0 === r) {
											try {
												null === (i = this.l) || void 0 === i || i.call(this, n);
											} catch {}
											((this.status = 2), this.v(n));
										} else {
											try {
												null === (s = this.u) || void 0 === s || s.call(this, r);
											} catch {}
							...
							render(t) {
								...
								switch (this.status) {
									case 0:
										return null === (e = t.initial) || void 0 === e ? void 0 : e.call(t);
									case 1:
										return null === (i = t.pending) || void 0 === i ? void 0 : i.call(t);
									case 2:
										return null === (s = t.complete) || void 0 === s ? void 0 : s.call(t, this.value);
									case 3:
										return null === (n = t.error) || void 0 === n ? void 0 : n.call(t, this.error);
									default:
										this.status;
								}
							}
							m(t) {
								...
								return (
									(this.p = t),
									Array.isArray(t) && Array.isArray(e) ? t.length === e.length && t.some((t, i) => g(t, e[i])) : t !== e
								);
							}
						})(
							this,
								...
								const s =
									null !== (e = this._itemsDataSource) && void 0 !== e
										...
										: await xt.get(
												...
												(t) => {
													var e;
													return (null === (e = t.payload) || void 0 === e ? void 0 : e.event) === this.dataSource;
												},
												i,
											);
								return (
						...
						void 0 !== this.dataSource &&
							...
							xt.sendToPropertyInspector.subscribe((t) => {
								...
								this._dataSourceInitialized &&
									(null === (e = t.payload) || void 0 === e ? void 0 : e.event) === this.dataSource &&
									((this._itemsDataSource = t), this.items.run());
							}));
				}
				renderDataSource(t, e) {
					if (void 0 === this.items.value || 0 === this.items.value.length) return [void 0];
					const i = (s) =>
						this.isItemGroup(s) ? (e ? e(s, s.children.map(i)) : void 0) : this.isItem(s) ? t(s) : void 0;
					return this.items.value.map(i);
				}
				getItemsFromChildNodes() {
					const t = (e, i) => (
						i instanceof HTMLOptGroupElement
							? e.push({ label: bt.getMessage(i.label), children: Array.from(i.childNodes).reduce(t, []) })
							: i instanceof HTMLOptionElement &&
								e.push({ disabled: i.disabled, label: bt.getMessage(i.text), value: i.value }),
						e
					);
			...
			return (
				...
				t([rt({ attribute: "hot-reload", type: Boolean }), e("design:type", Object)], s.prototype, "hotReload", void 0),
				t(
					[rt({ attribute: "loading", hasChanged: yt.hasChanged, converter: yt.converter }), e("design:type", Object)],
					s.prototype,
					"loadingText",
					void 0,
				),
	...
	const St = (t, e) => {
			...
			for (const t of n) (null === (s = (i = t)._$AO) || void 0 === s || s.call(i, e, !1), St(t, e));
			return !0;
		},
		Mt = (t) => {
			let e, i;
	...
	function It(t) {
		void 0 !== this._$AN ? (Mt(this), (this._$AM = t), kt(this)) : (this._$AM = t);
	}
	function Et(t, e = !1, i = 0) {
		...
		if (void 0 !== n && 0 !== n.size)
			if (e)
				if (Array.isArray(s)) for (let t = i; t < s.length; t++) (St(s[t], !1), Mt(s[t]));
	...
	const jt = new WeakMap(),
			...
			class extends Nt {
				...
				update(t, [e]) {
					...
					return (
						...
						(s || this.lt !== this.ct) &&
							((this.Y = e),
							(this.dt = null === (i = t.options) || void 0 === i ? void 0 : i.host),
				...
				get lt() {
					...
					return "function" == typeof this.Y
						? null === (e = jt.get(null !== (t = this.dt) && void 0 !== t ? t : globalThis)) || void 0 === e
							? void 0
							: e.get(this.Y)
		...
		zt = (i) => {
			...
			return (t([rt(yt), e("design:type", bt)], s.prototype, "label", void 0), s);
		},
		Ut = (i) => {
			class s extends i {
				parseValue(t) {
			...
			return (t([rt({ attribute: "value-type" }), e("design:type", Object)], s.prototype, "valueType", void 0), s);
		},
		Ot = (t) =>
			class extends t {
				constructor() {
				...
				focus() {
					void 0 !== this.focusElement.value &&
						(this.focusWithClick() ? this.focusElement.value.click() : this.focusElement.value.focus());
				}
				focusWithClick() {
					if (void 0 === this.focusElement.value) throw new Error("focusElement cannot be undefined.");
					return (
		...
		Rt = (i) => {
			...
			return (t([rt({ type: Number }), e("design:type", Object)], s.prototype, "columns", void 0), s);
		},
		...
		Zt = (i) => {
			...
			return (
				t([rt({ reflect: !0, type: Boolean }), e("design:type", Object)], s.prototype, "disabled", void 0),
				t([rt({ attribute: !1 }), e("design:type", Object)], s.prototype, "value", void 0),
				t([rt({ attribute: "default" }), e("design:type", Object)], s.prototype, "defaultValue", void 0),
				s
			);
		};
	class Yt {
		...
		use(t, e, i = 250, s = !0) {
			e &&
				this.didReceive.subscribe((i) => {
					var s;
					void 0 !== (null === (s = null == i ? void 0 : i.payload) || void 0 === s ? void 0 : s.settings) &&
						e(vt(t, i.payload.settings));
				});
			const n = i
				? (function (t, e) {
						let i, s;
				...
				: (e) => this.set(t, e, s);
			return [async () => (await this._initialization, vt(t, await this._settings)), n];
		}
		async set(t, e, i = !0) {
			...
			vt(t, this._settings) !== e &&
				(!(function (t, e, i) {
					const s = t.split(".");
					s.reduce((t, e, n) => (n === s.length - 1 ? (t[e] = i) : t[e] || (t[e] = {})), e);
				})(t, this._settings, e),
	...
	const Bt = new Yt(xt.didReceiveSettings, (t) => xt.setSettings(t)),
		Vt = Bt.use.bind(Bt);
	let Gt = !1;
	const Wt = new Yt(xt.didReceiveGlobalSettings, (t) => xt.setGlobalSettings(t)),
		Qt = (t, e, i = 250, s = !0) => (Gt || (xt.getGlobalSettings(), (Gt = !0)), Wt.use(t, e, i, s)),
		qt = (i) => {
			class s extends i {
				constructor() {
				...
				set value(t) {
					if (this._value != t) {
						const e = this._value;
						((this._value = t), this.requestUpdate("value", e), this.dispatchEvent(new Event("valuechange")));
					}
				}
				firstUpdated(t) {
			...
			return (
				t([rt({ attribute: "global", type: Boolean }), e("design:type", Object)], s.prototype, "isGlobal", void 0),
				t([rt(), e("design:type", String)], s.prototype, "setting", void 0),
				t(
					[rt({ attribute: !1 }), e("design:type", Object), e("design:paramtypes", [Object])],
					s.prototype,
					"value",
					null,
				),
	...
	class Kt {
		constructor(t, e) {
			((this.host = t), this.host.addController(this), (this.observer = new ht(e, this.handleMutation.bind(this))));
		}
		get items() {
		...
		mutated(t) {
			0 === this.items.length
				...
				: void 0 === this.dataList || this.dataList.id !== this.items[0].id
					? ((this.items[0].id = this.items[0].id || pt()), (this.dataList = this.items[0].cloneNode(!0)))
					: (t.preventRequestUpdate = !0);
		}
	}
	let te = class extends qt(Ot(Zt(et))) {
		constructor() {
			(super(...arguments), (this.dataListController = new Xt(this)), (this.type = "date"));
		}
		static get styles() {
			return [
				...super.styles,
	...
	(t([rt(), e("design:type", String)], te.prototype, "max", void 0),
		...
		t([rt({ type: Number }), e("design:type", Number)], te.prototype, "step", void 0),
	...
	(t([rt(yt), e("design:type", bt)], ee.prototype, "label", void 0), (ee = t([st("sdpi-checkbox")], ee)));
	let ie = class extends Rt(qt(ft(wt(Ut(Zt(et)))))) {
		static get styles() {
			return [...super.styles, a`.loading{margin:0;padding:calc(var(--spacer) * 1.5) 0;user-select:none}`];
		}
		render() {
	...
	(t([rt({ attribute: "format-type" }), e("design:type", Object)], ne.prototype, "formatType", void 0),
	...
	(t([rt(), e("design:type", String)], re.prototype, "accept", void 0), (re = t([st("sdpi-file")], re)));
	let oe = class extends et {
		render() {
			return this.key ? z`${gt.getMessage(this.key)}` : void 0;
		}
	};
	(t([rt(), e("design:type", String)], oe.prototype, "key", void 0), (oe = t([st("sdpi-i18n")], oe)));
	let ae = class extends qt(Ot(Zt(et))) {
		constructor() {
			(super(...arguments), (this.required = !1), (this.delaySave = !0), (this.type = "text"));
		}
		static get styles() {
			return [
				...super.styles,
	...
	(t([rt({ attribute: "maxlength", type: Number }), e("design:type", Number)], ae.prototype, "maxLength", void 0),
		t([rt(), e("design:type", String)], ae.prototype, "pattern", void 0),
		t([rt(yt), e("design:type", bt)], ae.prototype, "placeholder", void 0),
		t([rt({ type: Boolean }), e("design:type", Object)], ae.prototype, "required", void 0),
	...
	let ce = class extends qt(Ot(Zt(et))) {
		...
		render() {
			...
			const i =
					...
					(null === (e = this.defaultValue) || void 0 === e ? void 0 : e.toString()) ||
					"",
	...
	(t([rt({ type: Number }), e("design:type", Number)], ce.prototype, "max", void 0),
		t([rt({ type: Number }), e("design:type", Number)], ce.prototype, "min", void 0),
		t([rt({ attribute: "showlabels", type: Boolean }), e("design:type", Object)], ce.prototype, "showLabels", void 0),
		t([rt({ type: Number }), e("design:type", Number)], ce.prototype, "step", void 0),
	...
	const ve = (t) =>
		!((t) => null === t || ("object" != typeof t && "function" != typeof t))(t) && "function" == typeof t.then;
	const ge = Lt(
		class extends Nt {
			constructor() {
				(super(...arguments),
	...
	let be = class extends qt(Ot(wt(Ut(Zt(et))))) {
		...
		firstUpdated(t) {
			(super.firstUpdated(t),
				this.labelSetting && ([this.getLabel, this.setLabel] = Vt(this.labelSetting, null, null, !1)));
		}
		render() {
			var t, e;
			const i = this.disabled || this.items.status !== mt,
				s =
					this.getSelectedValueFrom(
						null !== (e = null === (t = this.items) || void 0 === t ? void 0 : t.value) && void 0 !== e ? e : [],
					) || this.defaultValue,
				n = z`<select ${Tt(this.focusElement)} .disabled="${i}" .value="${(null == s ? void 0 : s.toString()) || ""}" @change="${(
					t,
				) => {
					(this.setLabel && this.setLabel(t.target[t.target.selectedIndex].innerText),
						(this.value = this.parseValue(t.target.value)));
				}}">${this.items.render({
					pending: () => z`<option value="" disabled="disabled" selected="selected">${this.loadingText}</option>`,
					complete: () =>
		...
		async getLabelOrPlaceholder() {
			if (this.getLabel) {
				...
				if (void 0 !== t) return z`<option value="" disabled="disabled" selected="selected">${t}</option>`;
			}
			if (this.placeholder)
	...
	(t([rt({ attribute: "label-setting" }), e("design:type", String)], be.prototype, "labelSetting", void 0),
		t(
			[rt({ attribute: "show-refresh", type: Boolean }), e("design:type", Object)],
			be.prototype,
			"showRefresh",
			void 0,
		),
	...
	let ye = class extends qt(Ot(Zt(et))) {
		constructor() {
			(super(...arguments), (this.rows = 3), (this.showLength = !1), (this.delaySave = !0));
		}
		static get styles() {
			return [
				...super.styles,
	...
	(t([rt({ attribute: "maxlength", type: Number }), e("design:type", Number)], ye.prototype, "maxLength", void 0),
		t([rt({ type: Number }), e("design:type", Object)], ye.prototype, "rows", void 0),
		t([rt({ attribute: "showlength", type: Boolean }), e("design:type", Object)], ye.prototype, "showLength", void 0),
		(ye = t([st("sdpi-textarea")], ye)));
	const fe = window.connectElgatoStreamDeckSocket;
	var me;
	((window.connectElgatoStreamDeckSocket = (t, e, i, s, n) => {
		(fe && fe(t, e, i, s, n), xt.connect(t, e, i, JSON.parse(s), JSON.parse(n)));
	}),
		(function (t) {
			((t.streamDeckClient = xt), (t.useGlobalSettings = Qt), (t.useSettings = Vt), (t.i18n = gt));
		})(me || (me = {})),
